package org.foi.nwtis.ilucic.aplikacija_5.slusaci;
 ...
 */
@WebListener()
public class Slusac2 implements ServletContextListener {
  ...
  private void ucitajKonfiguraciju(ServletContext kontekst) {
    ...
    try {
      ...
      Logger.getLogger(Slusac2.class.getName()).log(Level.INFO, "Uspjesno ucitano!" + datoteka);
    } catch (Exception e) {
      Logger.getLogger(Slusac2.class.getName()).log(Level.SEVERE,
          "Problem s ucitavanjem" + path + datoteka);
    }
    try {
      ...
      if (provjeraAplikacije1 == null) {
        ...
        Logger.getLogger(Slusac2.class.getName()).log(Level.INFO,
