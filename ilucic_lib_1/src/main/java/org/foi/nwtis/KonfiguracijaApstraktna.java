...
import org.foi.nwtis.ilucic.konfiguracije.KonfiguracijaBin;
import org.foi.nwtis.ilucic.konfiguracije.KonfiguracijaJson;
import org.foi.nwtis.ilucic.konfiguracije.KonfiguracijaTxt;
import org.foi.nwtis.ilucic.konfiguracije.KonfiguracijaXml;
import org.foi.nwtis.ilucic.konfiguracije.KonfiguracijaYaml;
...
public abstract class KonfiguracijaApstraktna implements Konfiguracija {
  ...
  /**
   * Ažurira postojeću postavku ako postoji
   * 
   * @param kljuc - naziv postavke
   * @param vrijednost - vrijednost postavke
  ...
  /**
   * Provjera ima li takve postavke u memoriji.
   */
  @Override
